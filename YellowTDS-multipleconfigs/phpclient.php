<?php
/**
 * Biblioteca Cliente PHP YellowCloaker
 * 
 * Arquivo de inclusão simples para conectar sites PHP externos ao cloaker.
 * Basta incluir este arquivo no seu index.php assim:
 * require_once __DIR__ . '/phpclient.php';
 */

//se chamado diretamente retorna 404, haha
if (__FILE__ === $_SERVER['SCRIPT_FILENAME'] ||
    //correção para apache multiviews ou servidor php dev
...
class YellowCloakerClient 
{
    ...
    private function collectParams() 
    {
        ...
        //adicionando client hints se estiverem presentes
