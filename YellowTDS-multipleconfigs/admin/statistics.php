...
<body>
    ...
    <div class="buttons-block" style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            <button id="addNewTable" title="Adicionar nova tabela de estatísticas" class="btn btn-primary"><i
                    class="bi bi-plus-circle-fill"></i>&nbsp;Nova</button>
            ...
            <span style="margin-left: 20px; display: inline-block;">
                <label for="tableSelector" style="color: white; font-weight: bold;">Tabela:</label>
        ...
        <?php if (count($ss->tables)>0){ ?>
        <div>
            <button id="columnsSelect<?=$tDomId?>" title="Editar tabela" class="btn btn-info" style="margin-left: 8px;"><i
                    class="bi bi-layout-three-columns"></i></button>
            <button id="share<?=$tDomId?>" title="Compartilhar tabela com outras campanhas" class="btn btn-primary" style="margin-left: 8px;"><i
                    class="bi bi-share-fill"></i></button>
            <button id="download<?=$tDomId?>" title="Baixar tabela como XLSX" class="btn btn-success" style="margin-left: 8px;"><i
                    class="bi bi-download"></i></button>
            <button id="delete<?=$tDomId?>" title="Excluir tabela" class="btn btn-danger" style="margin-left: 8px;"><i
    ...
    <div id="shareStatsModal" class="ywbmodal" style="display:none;">
        <div class="modal-content">
            <div class="modal-body">
                <h5 id="shareStatsTitle">Compartilhar Tabela "<?=htmlspecialchars($tName)?>"</h5>
                <input type="text" id="shareStatsSearch" class="form-control" placeholder="Filtro rápido de campanhas...">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="shareStatsCancel">Cancelar</button>
    ...
    <script>
        ...
        document.getElementById('shareStatsConfirm').onclick = async () => {
            ...
            try {
                ...
                alert('Erro ao compartilhar tabela: ' + err.message);
            }
        };
    </script>
    <?php } ?>
