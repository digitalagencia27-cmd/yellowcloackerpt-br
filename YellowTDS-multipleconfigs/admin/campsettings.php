...
<body>
    ...
    <div class="all-content-wrapper">
        <div class="camp-layout">
            <nav class="camp-sidebar">
                ...
                <ul>
                    <li><a href="#sec-domains" class="active">Domínios</a></li>
                    <li><a href="#sec-safepage">Página Segura</a></li>
                    ...
                    <?php } ?>
                    <li><a href="#sec-flows">Fluxos</a></li>
                    ...
                    <li class="step-nav-item" data-flow-index="<?= $fi ?>" data-step-index="<?= $si ?>"><a href="#sec-step-<?= $fi ?>-<?= $si ?>">&nbsp;&nbsp;&nbsp;&nbsp;Etapa <?= $si + 1 ?></a></li>
                    <?php } ?>
                    <?php } ?>
                    <li><a href="#sec-scripts">Scripts</a></li>
                    <li><a href="#sec-statistics">Estatísticas</a></li>
        ...
        <form id="campsettings">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <label class="login2 pull-left pull-left-pro"> 
                        <i class="bi bi-info-circle admin-info-icon" title="Adicione todos os domínios da campanha SEM HTTP(S)! Você pode usar *.xxx.com para corresponder a TODOS os subdomínios."></i> Lista de Domínios
                </label>
                </div>
            </div>
            </div>
            ...
            <div id="domains_container">
                ...
                <div class="form-group-inner domain-item">
                    <div class="row">
                        <div class="col-lg-3"><label class="login2 pull-left pull-left-pro">Domínio:</label></div>
                        ...
                        <div class="col-lg-1 domain-status-col"><i class="bi bi-hourglass-split domain-status" style="color:#94a3b8" title="Verificando..."></i></div>
                        <div class="col-lg-2"><a href="javascript:void(0)" class="btn btn-danger btn-sm remove-domain-item" title="Excluir"><i class="bi bi-trash"></i></a></div>
                    </div>
                </div>
                <?php } ?>
            </div>
            <a id="add-domain-item" class="btn btn-primary btn-sm" href="javascript:void(0)"><i class="bi bi-plus-circle"></i> Adicionar Domínio</a>
            </section>

            <section id="sec-safepage" class="camp-section">
            <div class="flow-group">
            <span class="flow-group-title">Filtros</span>
            <div class="form-group-inner">
                <p>
                O tráfego que corresponder a estes filtros será mostrado na <strong>página segura</strong>. Todo o resto vai para a seção de Fluxos.
                </p>
                <div class="row">
            ...
            <div class="flow-group">
            <span class="flow-group-title">Escopo</span>
            <div class="form-group-inner">
                <div class="row">
                    <div class="col-lg-3"><label class="login2 pull-left pull-left-pro">Modo de página segura:</label></div>
                    <div class="col-lg-9">
                        <div class="ywb-radios">
                            <label class="ywb-radio-label"><input type="radio" <?= !$c->white->domainFilterEnabled ? 'checked' : '' ?> value="false" name="white.domainfilter.use" class="white-scope-radio" /> Global (mesma página segura para todos os domínios)</label>
                            <label class="ywb-radio-label"><input type="radio" <?= $c->white->domainFilterEnabled ? 'checked' : '' ?> value="true" name="white.domainfilter.use" class="white-scope-radio" /> Específico por Domínio (cada domínio tem sua própria configuração)</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flow-group">
            <span class="flow-group-title">Método</span>
            <div class="form-group-inner">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <label class="login2 pull-left pull-left-pro">Escolha o
                            método:</label>
                    </div>
                    <div class="col-lg-9 col-md-6 col-sm-6 col-xs-12">
                        <div class="ywb-radios">
                            <label class="ywb-radio-label"><input type="radio" <?= $c->white->action === 'folder' ? 'checked' : '' ?> value="folder" name="white.action" onclick="(document.getElementById('b_2').style.display = 'block'); (document.getElementById('b_3').style.display = 'none'); (document.getElementById('b_4').style.display = 'none'); (document.getElementById('b_5').style.display = 'none')" /> Página segura local de pasta</label>
                            <label class="ywb-radio-label"><input type="radio" <?= $c->white->action === 'redirect' ? 'checked' : '' ?> value="redirect" name="white.action" onclick="(document.getElementById('b_2').style.display = 'none'); (document.getElementById('b_3').style.display = 'block'); (document.getElementById('b_4').style.display = 'none'); (document.getElementById('b_5').style.display = 'none')" /> Redirecionar</label>
                            <label class="ywb-radio-label"><input type="radio" <?= $c->white->action === 'curl' ? 'checked' : '' ?> value="curl" name="white.action" onclick="(document.getElementById('b_2').style.display = 'none'); (document.getElementById('b_3').style.display = 'none'); (document.getElementById('b_4').style.display = 'block'); (document.getElementById('b_5').style.display = 'none')" /> Carregar site usando CURL</label>
                            <label class="ywb-radio-label"><input type="radio" <?= $c->white->action === 'error' ? 'checked' : '' ?> value="error" name="white.action" onclick="(document.getElementById('b_2').style.display = 'none'); (document.getElementById('b_3').style.display = 'none'); (document.getElementById('b_4').style.display = 'none'); (document.getElementById('b_5').style.display = 'block')" /> Retornar código HTTP <small>(404 Não Encontrado, 200 OK)</small></label>
                        </div>
                    </div>
                </div>
            </div>
            <div id="b_2" style="display:<?= $c->white->action === 'folder' ? 'block' : 'none' ?>;">
                <div id="white_folder_container">
                    ...
                    <div class="form-group-inner white-folder-item">
                        <div class="row">
                            <div class="col-lg-3"><label class="login2 pull-left pull-left-pro">Pasta da página segura:</label></div>
                            ...
                            <div class="col-lg-4"><div class="btn-group btn-group-sm"><a href="javascript:void(0)" class="btn btn-outline-secondary load-mode-btn" data-mode="<?= htmlspecialchars($c->white->getLoadMode($fn)) ?>" data-modes="base,rewrite,direct" title="Modo de carregamento"><i class="bi <?= match($c->white->getLoadMode($fn)) { 'rewrite' => 'bi-arrow-repeat', 'direct' => 'bi-hdd-network', default => 'bi-house-door' } ?>"></i></a><a href="javascript:void(0)" class="btn btn-warning white-edit-folder" title="Editar arquivos"><i class="bi bi-pencil-square"></i></a><a href="javascript:void(0)" class="btn btn-danger remove-white-folder-item" title="Excluir"><i class="bi bi-trash"></i></a></div></div>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                <a href="javascript:void(0)" class="btn btn-primary btn-sm white-add-existing"><i class="bi bi-folder-symlink"></i> Adicionar Existente</a>
                <a href="javascript:void(0)" class="btn btn-info btn-sm white-upload-zip"><i class="bi bi-upload"></i> Enviar ZIP</a>
            </div>
                    ...
                    <div class="form-group-inner redirect-item">
                        <div class="row">
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                <a href="javascript:void(0)" class="remove-redirect-item btn btn-danger btn-sm" title="Excluir"><i class="bi bi-trash"></i></a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                <a id="add-redirect-item" class="btn btn-primary" href="javascript:;">+ Adicionar Redirecionamento</a>

                <div class="form-group-inner">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <label class="login2 pull-left pull-left-pro">Tipo de redirecionamento:</label>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            ...
            <div id="b_4" style="display:<?= $c->white->action === 'curl' ? 'block' : 'none' ?>;">
                <div id="curl_container">
                    ...
                    <div class="form-group-inner curl-item">
                        <div class="row">
                            <div class="col-lg-3"><label class="login2 pull-left pull-left-pro">Endereço CURL:</label></div>
                            ...
                            <div class="col-lg-2"><div class="btn-group btn-group-sm"><a href="javascript:void(0)" class="btn btn-outline-secondary load-mode-btn" data-mode="<?= htmlspecialchars($c->white->getLoadMode($cu)) ?>" data-modes="rewrite,direct" title="Modo de carregamento"><i class="bi <?= $c->white->getLoadMode($cu) === 'direct' ? 'bi-hdd-network' : 'bi-arrow-repeat' ?>"></i></a><a href="javascript:void(0)" class="btn btn-danger remove-curl-item" title="Excluir"><i class="bi bi-trash"></i></a></div></div>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                <a id="add-curl-item" class="btn btn-primary" href="javascript:;">+ Adicionar CURL</a>
            </div>
            <div id="b_5" style="display:<?= $c->white->action === 'error' ? 'block' : 'none' ?>;">
                <div id="errorcodes_container">
                    ...
                    <div class="form-group-inner errorcode-item">
                        <div class="row">
                            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                <label class="login2 pull-left pull-left-pro">Código HTTP:</label>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <div class="input-group">
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                <a href="javascript:void(0)" class="remove-errorcode-item btn btn-danger btn-sm" title="Excluir"><i class="bi bi-trash"></i></a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                <a id="add-errorcode-item" class="btn btn-primary" href="javascript:;">+ Adicionar Código HTTP</a>
            </div>
            </div>
            ...
            <h5><?= htmlspecialchars($domainName) ?> — Página Segura</h5>

            <div class="form-group-inner">
                <div class="row">
                    <div class="col-lg-3"><label class="login2 pull-left pull-left-pro">Método:</label></div>
                    <div class="col-lg-9">
                        <div class="ywb-radios">
                            <label class="ywb-radio-label"><input type="radio" <?= $dwAction === 'folder' ? 'checked' : '' ?> value="folder" name="dws_action_<?= $di ?>" class="dws-action" data-di="<?= $di ?>" /> Pasta local</label>
                            <label class="ywb-radio-label"><input type="radio" <?= $dwAction === 'redirect' ? 'checked' : '' ?> value="redirect" name="dws_action_<?= $di ?>" class="dws-action" data-di="<?= $di ?>" /> Redirecionar</label>
                            ...
                            <label class="ywb-radio-label"><input type="radio" <?= $dwAction === 'error' ? 'checked' : '' ?> value="error" name="dws_action_<?= $di ?>" class="dws-action" data-di="<?= $di ?>" /> Código HTTP</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group-inner">
                <p>Fluxos são processados de cima para baixo. O primeiro fluxo cujos filtros corresponderem ao visitante recebe o tráfego. Filtros vazios = captura tudo.</p>
                <div id="flows-list">
                <?php foreach ($c->black->flows as $fi => $flow) { ?>
                ...
                <a id="add-flow-btn" class="btn btn-primary" href="javascript:void(0)" style="margin-top:15px;display:inline-block;">+ Adicionar Fluxo</a>
            </div>
            <hr/>
            <div class="form-group-inner">
                <div class="row">
            ...
            <div class="flow-group">
            <span class="flow-group-title">Detecção de Bot JS</span>
            <div class="form-group-inner">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <label class="login2 pull-left pull-left-pro">
            ...
            <div class="flow-group">
            <span class="flow-group-title">Filtros do Fluxo</span>
            <div class="form-group-inner">
                <div class="row">
            ...
            <div class="flow-group">
            <span class="flow-group-title">Distribuição</span>
            <div class="form-group-inner">
                <select class="form-select flow-dist" data-fi="<?= $fi ?>">
                    <option value="equal" <?= $flow->distribution === 'equal' ? 'selected' : '' ?>>Igual</option>
                    <option value="weighted" <?= $flow->distribution === 'weighted' ? 'selected' : '' ?>>Ponderado</option>
                    <option value="thompson" <?= $flow->distribution === 'thompson' ? 'selected' : '' ?>>Amostragem Thompson</option>
                </select>
            </div>
            ...
            <div class="flow-group">
            <span class="flow-group-title">Etapas</span>
            ...
            <div style="margin-top:10px;">
                <a href="javascript:void(0)" class="btn btn-primary btn-sm flow-add-step" data-fi="<?= $fi ?>"<?= $hasRedirect ? ' style="pointer-events:none;opacity:0.5" aria-disabled="true"' : '' ?>><i class="bi bi-plus-circle"></i> Adicionar Etapa</a>
            </div>
            </div>
            </section>
            ...
            <div class="flow-group">
            <span class="flow-group-title">Ação</span>
            <div class="form-group-inner">
                <div class="ywb-radios">
            ...
            <div class="flow-group">
            <span class="flow-group-title">Pastas</span>
            ...
            <div class="flow-group">
            <span class="flow-group-title">Redirecionamentos</span>
            ...
            <div class="flow-group">
            <span class="flow-group-title">Rastreamento de Eventos</span>
            <div class="form-group-inner">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <label class="login2 pull-left pull-left-pro">Rastrear profundidade de rolagem?</label>
                    </div>
                    <div class="col-lg-9 col-md-6 col-sm-6 col-xs-12">
                        <div class="ywb-radios">
            ...
            <div id="scroll_tracking_block" style="display:<?= $c->scripts->scrollTrackingUse ? 'block' : 'none' ?>;">
                <div class="form-group-inner">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <label class="login2 pull-left pull-left-pro">Limites de rolagem, %</label>
                        </div>
            ...
            <div class="form-group-inner">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <label class="login2 pull-left pull-left-pro">Rastrear tempo visível na página?</label>
                    </div>
                    <div class="col-lg-9 col-md-6 col-sm-6 col-xs-12">
                        <div class="ywb-radios">
            ...
            <div id="time_tracking_block" style="display:<?= $c->scripts->timeTrackingUse ? 'block' : 'none' ?>;">
                <div class="form-group-inner">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <label class="login2 pull-left pull-left-pro">Limites de tempo, segundos</label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group-inner">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <label class="login2 pull-left pull-left-pro"> Usar carregamento preguiçoso para imagens?
                        </label>
                    </div>
                    <div class="col-lg-9 col-md-6 col-sm-6 col-xs-12">
                        <div class="ywb-radios">
            ...
            <div class="form-group-inner">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <label class="login2 pull-left pull-left-pro"> Fuso horário para mostrar estatísticas:
                        </label>
                    </div>
            ...
            <div class="form-group-inner">
                ...
                <a id="add-s2s-item" class="btn btn-primary">+ Adicionar</a>
            </div>
            </div>
            </section>
    ...
    <div id="folderPickerModal" class="ywbmodal" style="max-width:420px !important;">
        <div class="fp-modal-content">
            <div class="fp-modal-header"><h5 style="margin:0;font-size:18px;color:#e2e8f0;">Selecionar Pasta</h5></div>
            <div class="fp-modal-body">
                <input type="text" id="fp-search" placeholder="Buscar..." class="fp-search-input">
                <div id="fp-list" class="fp-list-wrap"></div>
                <div id="fp-empty" style="display:none;color:#94a3b8;text-align:center;padding:20px 0;">Nenhuma pasta encontrada. Envie um ZIP primeiro.</div>
            </div>
            <div class="fp-modal-footer">
                <button type="button" class="btn btn-default btn-sm" id="fp-cancel">Cancelar</button>
    ...
    <div id="loadModeModal" class="ywbmodal" style="max-width:380px !important;">
        <div class="fp-modal-content">
            <div class="fp-modal-header"><h5 style="margin:0;font-size:18px;color:#e2e8f0;">Modo de Carregamento</h5></div>
            <div class="fp-modal-body" id="lm-body"></div>
            <div class="fp-modal-footer">
                <button type="button" class="btn btn-default btn-sm" id="lm-cancel">Cancelar</button>
